  ...
  return (
    <div className="grid grid-cols-4">
      <div className="col-span-3">
        ...
        <div className="mb-4">
          <p className="mb-1 text-sm">{`${t("price")} cho ${roomReservation.dayBooking} đêm, ${roomReservation.children} ${t("children")}`}</p>
        ...
        <div className="mt-6">
          <h3 className="mb-2 text-lg font-semibold">{t("facilities")}</h3>
